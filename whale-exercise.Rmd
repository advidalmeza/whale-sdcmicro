...
There are 2 direct identifiers present in this dataset. They are the *case_id* attribute for the whale entaglement event and *fishery_license* attribute for the fishing operation.
...
The variables that are numeric: lat, long 
Numeric variables that are also integer variables: year, month, fishery_license
Factor variables: inj_level, condition, fine, infraction_type
Character/string variables: type, county, state, origin, gear
